...
public class ProxyListsSingleParseFilter extends AbstractParseFilter {

    private final Logger logger = LoggerFactory.getLogger(ProxyListsSingleParseFilter.class);
