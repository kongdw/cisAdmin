...
public class JcaptchaFormAuthenticationFilter extends FormAuthenticationFilter {
            ...
            if (authAccount != null) {
                ...
                if (AuthSourceEnum.A.equals(token.getSource())) {
                    if (!Boolean.TRUE.equals(authAccount.getMgmtGranted())) {
                        throw new AuthenticationValidationException("当前登录账号未授权管理访问权限");
                    }
                }
                ...
                throw new AuthenticationValidationException("登录账号或密码不正确");
            }
    ...
    */
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request, ServletResponse response) {
        //失败记录
        User authAccount = (User) request.getAttribute("authAccount");
        if (authAccount != null) {
    ...
    */
    ...
    public static class AuthenticationValidationException extends AuthenticationException {
